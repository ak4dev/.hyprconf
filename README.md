...
| [`hypr`](modules/hypr/README.md) | The keymap, the look'n'feel and input deltas (copies in `~/.config/hypr/`), the monitor presets, `hyprconf-gaps` and `hyprconf-monitor-preset` | `bash modules/hypr/install` | `bash modules/hypr/install undo` |
